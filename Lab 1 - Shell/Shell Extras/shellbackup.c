...
// void execute_command(char **array, int in, int out, int pipenum, int size_arr, char *infile, char *outfile, int *sleep);
...
//             execute_command(array, in, out, pipenum, size_arr, infile, outfile, &sleep);
//         }
//     }
//     exit(EXIT_SUCCESS);
// }
